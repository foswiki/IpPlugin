...
package Foswiki::Plugins::IpPlugin;
...
sub initPlugin {
  ...
  if( $Foswiki::Plugins::VERSION < 1.026 ) {
    Foswiki::Func::writeWarning( "Version mismatch between IpPlugin and Plugins.pm" );
    return 0;
  }

  # register the tag handlers
  Foswiki::Func::registerTagHandler( 'IP', \&_IP);
